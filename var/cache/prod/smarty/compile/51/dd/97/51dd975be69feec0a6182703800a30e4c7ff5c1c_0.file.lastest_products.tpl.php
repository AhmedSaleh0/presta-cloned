...
/* Smarty version 3.1.33, created on 2020-10-14 16:19:41
  from '/opt/bitnami/apache/htdocs/modules/ets_marketplace/views/templates/hook/dashboard/lastest_products.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5f8708fd9c8cc0_94387195',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '51dd975be69feec0a6182703800a30e4c7ff5c1c' => 
    array (
      0 => '/opt/bitnami/apache/htdocs/modules/ets_marketplace/views/templates/hook/dashboard/lastest_products.tpl',
      1 => 1602685098,
      2 => 'file',
    ),
  ),
...
function content_5f8708fd9c8cc0_94387195 (Smarty_Internal_Template $_smarty_tpl) {
?><table class="table">
    <thead>
        <tr>
            <th><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'ID','mod'=>'ets_marketplace'),$_smarty_tpl ) );?>
</th>
            <th><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Image','mod'=>'ets_marketplace'),$_smarty_tpl ) );?>
</th>
            ...
            <th class="text-center"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Quantity','mod'=>'ets_marketplace'),$_smarty_tpl ) );?>
</th>
            ...
            <th class="text-center"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Added date','mod'=>'ets_marketplace'),$_smarty_tpl ) );?>
</th>
    ...
    <tbody>
        <?php if ($_smarty_tpl->tpl_vars['lastest_products']->value) {?>
            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['lastest_products']->value, 'product');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['product']->value) {
?>
                <tr>
                    <td><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product']);?>
</td>
                    ...
                    <td class="text-center"><?php echo intval($_smarty_tpl->tpl_vars['product']->value['quantity']);?>
</td>
                                        <td class="shop_name">
                        <?php if ($_smarty_tpl->tpl_vars['product']->value['id_seller']) {?>
                            <a href="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['module']->value->getShopLink(array('id_seller'=>$_smarty_tpl->tpl_vars['product']->value['id_seller'])),'html','UTF-8' ));?>
"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['product']->value['shop_name'],'html','UTF-8' ));?>
</a>
                        <?php } else { ?>
...
"></i>
                    ...
                    <td class="text-center"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['dateFormat'][0], array( array('date'=>$_smarty_tpl->tpl_vars['product']->value['date_add'],'full'=>1),$_smarty_tpl ) );?>
</td>
                    <td class="text-right">
