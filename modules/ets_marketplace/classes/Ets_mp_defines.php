        ...
        if($type =='settings')
        {
            ...
            return array(
                ...
                array(
                    ...
                    'label' => $this->l('Suggestion and auto-fill address using Google Map API'),
                    'default'=> 0,
                ...
                array(
                    ...
                    'desc' => $this->l('To learn how to get an API key, please visit this site').'<'.'a hr'.'ef="https://developers.google.com/places/web-service/get-api-key" tar'.'get="_bl'.'ank"> https://developers.google.com/places/web-service/get-api-key<'.'/'.'a'.'>',
                ),
                array(
                    'type'=>'file',
                    'name' => 'ETS_MP_GOOGLE_MAP_LOGO',
                    'label' => $this->l('Logo for map'),
                    'tab'=>'map_settings',
                    'imageType' => 'map',
