...
$(document).ready(function(){
    ...
    {
        setTimeout(function(){ ets_mp_load_map();},300);
    }
...
{
	var html = '<img src="'+has_store_picture+'" alt="" style="width: 100px;float:left;margin-bottom: 6px;border: 1px solid #cccccc;margin-right: 10px;"/><span class="shop_map_info"><b>'+name+'</b><br/>'+address+(has_store_picture ? '</span><br />' : '')+other+'<a href="http://maps.google.com/maps?saddr=&daddr='+latlng+'" target="_blank">'+translation_5+'<\/a>';
