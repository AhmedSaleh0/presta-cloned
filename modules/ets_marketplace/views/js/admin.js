...
$(document).ready(function(){
    ...
    $(document).on('click','input[name="ETS_MP_DISPLAY_FOLLOWED_SHOP"],input[name="ETS_MP_DISPLAY_PRODUCT_FOLLOWED_SHOP"],input[name="ETS_MP_DISPLAY_PRODUCT_TRENDING_SHOP"],input[name="ETS_MP_ENABLE_MAP"], input[name="ETS_MP_SEARCH_ADDRESS_BY_GOOGLE"],input[name="ETS_MP_ENABLE_CAPTCHA"],SELECT[name="ETS_MP_ENABLE_CAPTCHA_TYPE"],input[name="ETS_MP_SELLER_CREATE_ATTRIBUTE"],input[name="ETS_MP_SELLER_CREATE_FEATURE"],input[name="ETS_MP_SELLER_CREATE_SHIPPING"],input[name="ETS_MP_SELLER_CREATE_BRAND"],input[name="ETS_MP_APPLICABLE_CATEGORIES"],input[name="ETS_MP_SELLER_FEE_TYPE"],input[name="ETS_MP_SELLER_CAN_CHANGE_ORDER_STATUS"]',function(){
...
function ets_mp_displayFormInput()
{
    ...
    if($('input[name="ETS_MP_SELLER_CREATE_SHIPPING"]:checked').val()==1)
        $('.form-group.create_shipping').show();
    else
        $('.form-group.create_shipping').hide();
    if($('input[name="ETS_MP_SELLER_CREATE_BRAND"]:checked').val()==1)
        $('.form-group.create_brand').show();
    else
        $('.form-group.create_brand').hide();
    if($('input[name="ETS_MP_SELLER_CREATE_ATTRIBUTE"]:checked').val()==1)
        $('.form-group.create_attribute').show();
    else
        $('.form-group.create_attribute').hide();
    if($('input[name="ETS_MP_SELLER_CREATE_FEATURE"]:checked').val()==1)
        $('.form-group.create_feature').show();
    else
        $('.form-group.create_feature').hide();
