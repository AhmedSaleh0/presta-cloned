...
{block name='description'}
    {if $input.name=='ETS_MP_ENABLE_CAPTCHA_TYPE'}
        <p class="help-block" style="margin-bottom: 0px;">
            <span  class="form-group captcha v2"><a target="_blank" href="{$link_base|escape:'html':'UTF-8'}/modules/ets_marketplace/recaptcha_v2.pdf">{l s='How to get Site key and Secret key for reCAPTCHA v2' mod='ets_marketplace'}</a></span>
            <span class="form-group captcha v3"><a target="_blank" href="{$link_base|escape:'html':'UTF-8'}/modules/ets_marketplace/recaptcha_v3.pdf">{l s='How to get Site key and Secret key for reCAPTCHA v3' mod='ets_marketplace'}</a></span>
        </p>
    {else}
