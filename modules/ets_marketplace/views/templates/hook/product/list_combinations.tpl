                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <fieldset class="form-group">
                                                ...
                                                <input id="combination_{$productAttribute.id_product_attribute|intval}_attribute_reference" name="combinations_attribute_reference[{$productAttribute.id_product_attribute|intval}]" class="form-control" type="text" />
                                            </fieldset>
                                        </div>
                                    </div>
