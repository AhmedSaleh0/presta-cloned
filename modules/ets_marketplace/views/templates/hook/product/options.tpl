...
Required</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a class="btn btn-outline-secondary mb-2 collapsed" href="#collapsedForm" data-toggle="collapse" aria-expanded="false" aria-controls="collapsedForm">
                                <i class="fa fa-plus-circle"></i>
                            ...
                            <fieldset id="collapsedForm" class="collapse" style="">
                                <div id="form_step6_attachment_product">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button id="form_step6_attachment_product_cancel" class="btn-outline-secondary pull-right mr-2 btn collapsed" type="button" name="attachment_product_cancel" data-toggle="collapse" data-target="#collapsedForm" aria-expanded="false">{l s='Cancel' mod='ets_marketplace'}</button>
                                        </div>
                                </div>
                            </fieldset>
                        </div>
