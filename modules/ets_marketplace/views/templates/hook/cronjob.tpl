        ...
        <div class="emp-cronjob ets_mp_form configuration active">
        	<div class="row mt-15">
        		<div class="col-lg-12">
        			...
        			<p class="ets-mp-text-strong emp-block mb-15"><span style="color: red;">*</span> {l s=' Setup a cronjob as below on your server to automatically send emails to sellers when their seller account is going to be expired.' mod='ets_marketplace'}</p>
