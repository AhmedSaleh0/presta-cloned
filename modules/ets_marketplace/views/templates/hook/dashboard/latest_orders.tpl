...
<table class="table">
    ...
    {if $latest_orders}
        {foreach from=$latest_orders item='order'}
            <tr>
                <td class="text-center">{$order.id_order|intval}</td>
                <td>{$order.reference|escape:'html':'UTF-8'}</td>
                <td>{$order.customer_name nofilter}</td>
                <td class="text-center">{displayPrice price=$order.total_paid_tax_incl currency=$order.id_currency}</td>
                ...
                <td class="text-center">{displayPrice price=$order.total_commission}</td>
                <td class="text-center">{displayPrice price=$order.admin_earned}</td>
                <td class="text-center">{$order.current_state nofilter}</td>
