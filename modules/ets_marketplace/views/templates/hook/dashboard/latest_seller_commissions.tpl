    ...
    {if $latest_seller_commissions}
        {foreach from=$latest_seller_commissions item='commission'}
            <tr>
                ...
                <td class="text-center">{$commission.id_order|escape:'html':'UTF-8'}</td>
                <td>{$commission.product_name nofilter}</td>
                <td class="text-center">{if $commission.price_tax_incl!=0}{displayPrice price=$commission.price_tax_incl}{/if}</td>
                <td class="text-center">{$commission.quantity|escape:'html':'UTF-8'}</td>
                <td class="text-center">{displayPrice price=$commission.commission}</td>
                <td>
