...
var charxlabelString = '{l s='Day' mod='ets_marketplace' js=1}';
            ...
            <div class="row margin-15 ">
                ...
                <div class="col-lg-2 box-padding-col box-static box-static-earning">
                    <div class="box-info js-type-info-stats" style="background: #45bbe2;">
                        <div class="box-inner earning">
                            ...
                            <span>{l s='Total money admin earned from seller products and Memberships fee' mod='ets_marketplace'} </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 box-padding-col box-static box-static-fee">
                    <div class="box-info js-type-info-fee" style="background: #fbbb21;">
                        <div class="box-inner revenve">
                            <div class="box-inner-top">
                                <h5 class="box-info-title">{l s='Memberships fee' mod='ets_marketplace'}</h5>
                                <div class="box-info-content"> {displayPrice price=$totalSellerFee|floatval} </div>
                            </div>
                            <span>{l s='Total money admin earned from Memberships fee' mod='ets_marketplace'} </span>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="box-header">
                                        ...
                                        <div class="box-tool-dropdown">
                                            <select name="filter-time-stats-commissions">
                                                ...
                                                <option value="this_month" selected="selected">{l s='This month' mod='ets_marketplace'}</option>
                        ...
                        <div class="stats-container">
                            <div class="stats-body">
                                <div class="box-dashboard latest-payment-billings">
                                    <div class="box-header">
                                        <h4 class="box-title">
                                            {l s='Latest memberships' mod='ets_marketplace'}
                                            <i class="fa fa-question-circle">
                                                <span class="ets_tooltip" data-tooltip="top">{l s='Latest payment billings generated when sellers pay for Memberships fee' mod='ets_marketplace'}</span>
                                            </i>
                                        </h4>
                                    </div>
                                    <div class="box-body">
