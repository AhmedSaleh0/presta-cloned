                            ...
                            <div class="row">
                                <div class="col-lg-5 pl-15 pr-15">
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <div class="row">
            								<label class="control-label col-lg-6"><em>{l s='Withdrawn' mod='ets_marketplace'}</em>
            									<i class="fa fa-question-circle">
                                        ...
                                        <div class="row">
            								<label class="control-label col-lg-6"><em>{l s='Paid for orders' mod='ets_marketplace'}</em>
            									<i class="fa fa-question-circle">
                                        ...
                                        <div class="row">
            								<label class="control-label col-lg-6"><em>{l s='Converted to voucher' mod='ets_marketplace'}</em>
            									<i class="fa fa-question-circle">
                                        ...
                                        <div class="row">
            								<label class="control-label col-lg-6"><em>{l s='Total used' mod='ets_marketplace'}</em>
            									<i class="fa fa-question-circle">
                                ...
                                <div class="col-lg-7 pl-15 pr-15">
                                    <div class="ets_mp-title-section">
