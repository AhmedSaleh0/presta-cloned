                                        ...
                                        <td class="text-right">
                                            <div class="btn-group-action">
                                                <div class="btn-group pull-right">
                                                        ...
                                                        {/if}
                                                        {if $actions[0]=='delete'}
                                                            <a onclick="return confirm('{l s='Do you want to delete this item?' mod='ets_marketplace' js=1}');" href="{$currentIndex|escape:'html':'UTF-8'}&{$identifier|escape:'html':'UTF-8'}={$row.$identifier|escape:'html':'UTF-8'}&del=yes"><i class="icon-trash fa fa-trash"></i> {l s='Delete' mod='ets_marketplace'}</a>
                                                        {/if}
                                                        {if $actions[0]=='reply'}
                                                        ...
                                                        {/if}
                                                        {if $actions|count >=2 && (!isset($row.action_edit) || $row.action_edit || in_array('action',$actions))}
                                                                ...
                                                                {foreach from=$actions item='action' key='key'}
                                                                    {if $key!=0}
                                                                        {if $action=='delete' && (!isset($row.view_order_url) || (isset($row.view_order_url) && !$row.view_order_url) )}
                                                                            <li><a onclick="return confirm('{if $name=='mp_front_products' || $name=='mp_products'}{l s='Do you want to delete this product?' mod='ets_marketplace'}{else}{l s='Do you want to delete this item?' mod='ets_marketplace'}{/if}');" href="{$currentIndex|escape:'html':'UTF-8'}&{$identifier|escape:'html':'UTF-8'}={$row.$identifier|escape:'html':'UTF-8'}&del=yes{if isset($row.type)}&type={$row.type|escape:'html':'UTF-8'}{/if}"><i class="fa fa-trash icon-trash"></i> {l s='Delete' mod='ets_marketplace'}</a></li>
                                                                        {/if}
