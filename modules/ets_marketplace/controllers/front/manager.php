...
class Ets_MarketPlaceManagerModuleFrontController extends ModuleFrontController
{
    ...
    public function displayPermission($permission)
    {
        ...
        $permissions = array(
            ...
            'billing'=>array(
                'name'=> $this->module->l('Memberships','manager') ,
                'id'=>'billing'
            ),
            'attributes'=> array(
                'name'=> in_array('standard_product',$product_types) && Configuration::get('ETS_MP_SELLER_CREATE_ATTRIBUTE') && Configuration::get('ETS_MP_SELLER_CREATE_FEATURE') ?  $this->module->l('Attributes and features','manager') : (Configuration::get('ETS_MP_SELLER_CREATE_FEATURE') ? $this->module->l('Features','manager') : $this->module->l('Attributes','manager')),
                'id'=>'attributes'
            ),
            'brands'=>array(
    ...
    public function _initContent()
    {
        ...
        $paggination->url = $this->context->link->getModuleLink($this->module->name,'manager',array('list'=>1)).$this->module->getFilterParams($fields_list,'mp_manager');
