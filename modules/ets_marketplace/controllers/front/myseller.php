...
class Ets_MarketPlaceMySellerModuleFrontController extends ModuleFrontController
{
    ...
    public function _initContent()
    {
        ...
        $seller_pages = array(
            ...
            'attributes'=>array(
                'page' => 'attributes',
                'name' => in_array('standard_product',$product_types) && Configuration::get('ETS_MP_SELLER_CREATE_ATTRIBUTE') && Configuration::get('ETS_MP_SELLER_CREATE_FEATURE') ?  $this->module->l('Attributes and features','myseller') : (Configuration::get('ETS_MP_SELLER_CREATE_FEATURE') ? $this->module->l('Features','myseller') : $this->module->l('Attributes','myseller') ),
                'link' => in_array('standard_product',$product_types) && Configuration::get('ETS_MP_SELLER_CREATE_ATTRIBUTE') ? $this->context->link->getModuleLink($this->module->name,'attributes') : $this->context->link->getModuleLink($this->module->name,'features'),
            ),
            'carrier'=>array(
                'page' => 'carrier',
            ...
            'billing' =>array(
                'page' => 'billing',
                'name' => $this->module->l('Memberships','myseller'),
