        ...
        if(Tools::isSubmit('saveShopGroup'))
        {
            ...
            foreach($languages as $language)
            {
                ...
                if(Tools::getValue('level_name_'.$language['id_lang']) && !Validate::isCleanHtml(Tools::getValue('level_name_'.$language['id_lang'])))
                    $errors[] = $this->l('Level name is not valid in').' '.$language['iso_code'];
            }
            ...
            if(!Tools::getValue('use_commission_global'))
            {
                ...
                elseif(!Validate::isPrice(Tools::getValue('commission_rate')) || Tools::getValue('commission_rate')<=0)
        ...
        $fields_form = array(
			'form' => array(
				...
				'input' => array(					
                    ...
                    array(
						'type' => 'file',
						'label' => $this->l('Level badge image'),
						'name' => 'badge_image',
