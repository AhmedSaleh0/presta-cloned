...
class Tm_Cms1block extends Module implements WidgetInterface
{
    ...
    public function runInstallSteps()
    {
        return parent::install()
            && $this->installDB()
            && $this->registerHook('displayTopBelow')
   ...
   public function processSaveCms1Block()
    ...
    public function installFixtures()
    {
        ...
        $tabTexts = array(
            array(
                'text' => '<div class="tmcms1block">
                <div class="first-cms main-content">
                <div class="cms_content">
                <div class="cms_img"><a href="#"><img class="lazyload" alt="Cms-Banner1.jpg" src="img/cms/Sub-banner-1.jpg" /></a></div>
                <div class="cms-block">
                <div class="cms_offer">New Digital</div>
                <div class="cms_offer1">Smart LED</div>
                <div class="cms_offer2">View More</div>
                </div>
                </div>
                </div>
                <div class="second-cms main-content">
                <div class="cms_content">
                <div class="cms_img"><a href="#"> <img class="lazyload" alt="Cms-Banner2.jpg" src="img/cms/Sub-banner-2.jpg" /></a></div>
                <div class="cms-block">
                <div class="cms_offer">Discount 20%</div>
                <div class="cms_offer1">New Speaker</div>
                <div class="cms_offer2">View More</div>
                </div>
                </div>
                </div>
