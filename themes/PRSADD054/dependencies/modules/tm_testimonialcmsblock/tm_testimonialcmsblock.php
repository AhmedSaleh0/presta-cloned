...
class Tm_Testimonialcmsblock extends Module implements WidgetInterface
{
   ...
   public function processSaveTestimonialCmsBlock()
    ...
    public function installFixtures()
    {
        ...
        $tabTexts = array(
            array(
                'text' => '<div class="cms_flexslider">
                <div class="h3 title_block"><span> Testimonial</span> <span class="pull-xs-right"> <span class="navbar-toggler collapse-icons"> <i class="material-icons add"></i> <i class="material-icons remove"></i> </span> </span></div>
                <div class="block_content">
                <div class="customNavigation"></div>
                <ul id="tmlefttestimonial-carousel" class="tm-carousel">
                <li class="item">
                <div class="main_content">
                <div class="main-block">
                <div class="image"><img class="lazyload" src="img/cms/testimonials_1.jpg" alt="testimonials_1.jpg" /></div>
                <div class="description">" majority have suffered injected humor, ods believable. "</div>
                <div class="title"><span class="name">Mack jecknowda</span><br /><span class="subheading">Web Designer</span></div>
                </div>
                </div>
                </li>
                <li class="item">
                <div class="main_content">
                <div class="main-block">
                <div class="image"><img class="lazyload" src="img/cms/testimonials_2.jpg" alt="testimonials_2.jpg" /></div>
                <div class="description">" majority have suffered injected humor, ods believable. "</div>
                <div class="title"><span class="name">Mack jecknowda</span><br /><span class="subheading">Web Designer</span></div>
                </div>
                </div>
                ...
                <div class="main_content">
                <div class="main-block">
                <div class="image"><img class="lazyload" src="img/cms/testimonials_3.jpg" alt="testimonials_3.jpg" /></div>
                <div class="description">" majority have suffered injected humor, ods believable. "</div>
                <div class="title"><span class="name">Mack jecknowda</span><br /><span class="subheading">Web Designer</span></div>
                </div>
                </div>
