...
class Tm_Footercmsblock extends Module implements WidgetInterface
{
   ...
   public function processSaveFooterCmsBlock()
    ...
    public function installFixtures()
    {
        ...
        $tabTexts = array(
            array(
                'text' => '<div id="footerlogo">
                <div class="footer_logo"><a href="#"> <img class="lazyload" alt="footer-logo.png" src="img/cms/footer-logo.png" /></a></div>
                <div class="footer-desc">
                <p>Took a gallery of type and scrambled survived not only five centur but also the leap into electronic</p>
                </div>
                </div>'
            ),
        );
