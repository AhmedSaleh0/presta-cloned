...
class Tm_Cms2block extends Module implements WidgetInterface
{
   ...
   public function processSaveCms2Block()
    ...
    public function installFixtures()
    {
        ...
        $tabTexts = array(
            array(
                'text' => '<div class="tmcms2block">
                <div class="first-cms main-content">
                <div class="cms_content">
                <div class="cms_img"><a href="#"><img class="lazyload" alt="Cms-Banner3.jpg" src="img/cms/Sub-banner-3.jpg" /> </a></div>
                <div class="cms-block">
                <div class="cms_offer">Discount 20%</div>
                <div class="cms_offer1">Smart Phone</div>
                ...
                <div class="cms_content">
                <div class="cms_img"><a href="#"> <img class="lazyload" alt="Cms-Banner4.jpg" src="img/cms/Sub-banner-4.jpg" /> </a></div>
                <div class="cms-block">
                <div class="cms_offer">Sale 30% Flat</div>
                <div class="cms_offer1">New Tablet</div>
                <div class="cms_offer2">View More</div>
                </div>
                </div>
                </div>
