...
<div class="block-contact col-md-4 links wrapper ight_side hb-animate-element right-to-left">
   		...
   		<h3 class="h3 hidden-md-down"><a href="{$urls.pages.stores}">{l s='Contact Us' d='Shop.Theme.Global'}</a></h3>
    ...
    <i class="material-icons remove">&#xE316;</i>
	 ...
	 <div class="contactdiv"> {$contact_infos.address.formatted nofilter}</div>
	  </li>
