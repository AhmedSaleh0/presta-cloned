...
<div class="lastest_block block tmblog-latest">
	<h2 class="h1 products-section-title text-uppercase hidden-md-down">
		{l s='Latest News' d='Shop.Theme.Global'}
	</h2>
		<h4 class=" hidden-lg-up block_title" data-target="#block_lastest_toggle" data-toggle="collapse">{l s='Latest News' d='Shop.Theme.Catalog'}
	...
	<div id="spe_res">
	<div class="homeblog-inner collapse" id="block_lastest_toggle">
