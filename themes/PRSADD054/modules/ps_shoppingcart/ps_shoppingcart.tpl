  ...
  <div class="blockcart cart-preview {if $cart.products_count > 0}active{else}inactive{/if}" data-refresh-url="{$refresh_url}">
    <div class="header blockcart-header dropdown js-dropdown">
		...
		<a rel="nofollow" href="{$cart_url}" {if $cart.products_count > 0} data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"{/if}> 
			<div id="bgimage"></div>
			<div class="cart-titlle">
				<!-- <i class="cart material-icons">&#xE8CC;</i> -->
				<span class="cart-title hidden-md-down">{l s='Shopping Cart' d='Shop.Theme.Checkout'}</span>
				<span class="cart-products-count">({$cart.products_count}) item</span>
